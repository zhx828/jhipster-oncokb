...
class ArticleGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Article entity")
        ...
        .repeat(2) {
            ...
            .post("/api/articles")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "pmid":"SAMPLE_TEXT", "title":"SAMPLE_TEXT", "journal":"SAMPLE_TEXT", "pubDate":"SAMPLE_TEXT", "volume":"SAMPLE_TEXT", "issue":"SAMPLE_TEXT", "pages":"SAMPLE_TEXT", "authors":"SAMPLE_TEXT", "elocationId":"SAMPLE_TEXT", "abstractContent":"SAMPLE_TEXT", "link":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
